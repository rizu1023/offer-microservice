...
insert into Employee(id,name,gender,age) values(1,'Rizwan','male',20);
insert into Employee(id,name,gender,age) values(2,'Karthik','male',30);
insert into Employee(id,name,gender,age) values(3,'Debraj','male',25);
